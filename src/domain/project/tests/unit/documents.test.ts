...
import { parseTasks, qualifiedTaskId } from '../../../task/task-list.mjs';
import { parseWorkItemSpec, validateSpec } from '../../../work-item/specification.mjs';

const parseBacklogTyped = parseBacklog;
const parseTasksTyped = parseTasks;
const parseSpecTyped = parseWorkItemSpec;
const parseReviewTyped = parseReview;
...
test('specifications and reviews enforce ownership and canonical metadata', () => {
  ...
  const pending = { schema_version: 1, work_item: 'W101', status: 'pending' } as const;
