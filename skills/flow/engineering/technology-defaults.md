...
## Decision rule
When an existing mature repository has a clearly enforced convention, `preserve` may retain it. Under `rebaseline`, technology defaults and project requirements outrank accidental existing style.
